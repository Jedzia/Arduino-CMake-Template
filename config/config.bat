...
set PATH=C:\Toolchain\AVR\avr-gcc-9.1.0-x64-mingw\bin;C:\tools\gnu\bin;C:\msys64\usr\bin;C:\msys64\mingw64\bin;C:\Toolchain\OpenOCD\OpenOCD-20190210-0.10.0\bin;%PATH%
